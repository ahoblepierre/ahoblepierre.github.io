  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        ...
        layout: "media-right",
        screens: [
          { src: images.crmEventsScreens.login, alt: "CRM Events login screen" },
          { src: images.crmEventsScreens.vendors, alt: "CRM Events vendor list with venues, prices and quotes" },
          { src: images.crmEventsScreens.events, alt: "CRM Events home screen listing upcoming events" },
        ],
      ...
      },
      {
        ...
        screenStyle: "store",
        screens: [
          { src: images.pourpiecesScreens.categories, alt: "Pourpièces App Store screenshot: all categories" },
          { src: images.pourpiecesScreens.home, alt: "Pourpièces App Store screenshot: the first platform dedicated to broken items" },
          { src: images.pourpiecesScreens.filters, alt: "Pourpièces App Store screenshot: search filters by city, postcode and country" },
        ],
      ...
      },
      {
        ...
        illustration: {
          ...
          models: ["AgentTimeTable", "TimeTable", "TimeTableDay"],
          modelsCaption: "Scheduling model",
        },
      ...
      },
      {
        ...
        illustration: {
          ...
          methods: ["Orange Money", "MTN MoMo", "Moov Money", "Bank"],
          cta: "Convert",
          numberLocale: "en-US",
        },
