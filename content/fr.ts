...
export const fr: Dictionary = {
  ...
  hero: {
    ...
    titleLead: "Je construis des produits numériques, du *backend* au",
    ...
    projects: [
      ...
      },
      {
        ...
        illustration: {
          ...
          modelsCaption: "Modèle de planification",
        },
      ...
      },
      {
        ...
        illustration: {
          ...
          badge: "Concept",
          send: "Vous envoyez",
          receive: "Ils reçoivent",
          rateLabel: "Taux fixe",
          methods: ["Orange Money", "MTN MoMo", "Moov Money", "Banque"],
          cta: "Convertir",
          numberLocale: "fr-FR",
        },
